...
function Header() {
  ...
  return (
    <div className="flex justify-between items-center p-3 bg-gray-100 shadow-md h-18">
      <div className="flex flex-col justify-center">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">QuickChat</h1>
        <h2 className="text-xl text-gray-600 mb-1 ms-1">Welcome, {username}</h2>
      </div>
      <div className="flex items-center relative">
        ...
        {dropdownOpen && (
          <div
            ...
            className="absolute right-0 mt-2 bg-white border border-gray-200 rounded-lg shadow-md w-48"
          >
            <button
